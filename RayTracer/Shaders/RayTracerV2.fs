...
{
    // Y axis plane
    {vec3(0.0,1.0,0.0), vec3(0.0,-3.0,0.0), vec3(0.5,0.5,0.5), vec3(0.5,0.5,0.5), vec3(0.5,0.5,0.5), 0.0 },
    { vec3(0.0,0.0,-1.0), vec3(0.0,0.0,8.0), vec3(0.5,0.5,0.5), vec3(0.5,0.5,0.5), vec3(0.5,0.5,0.5), 0.0 }
};
...
void main() 
{
    ...
    // animate the light
    lights[0].pos.x = lights[0].pos.x + 5 * cos(t);
    lights[0].pos.z = lights[0].pos.z + 5 * sin(t);
